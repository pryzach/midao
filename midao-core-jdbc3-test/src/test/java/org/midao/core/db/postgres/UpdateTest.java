...
import org.midao.core.db.DBUpdate;
import org.midao.core.db.DBUpdateQueryStructure;
...
public class UpdateTest extends BasePostgres {
	...
	public void testGeneratedKeys() throws SQLException {
    	...
    	QueryStructure structure = new QueryStructure(values) {
			...
			public void create(QueryRunnerService runner) throws SQLException {
				this.values.put("createUpdatedCount", (Integer) runner.update(DBConstants.CREATE_STUDENT_TABLE_POSTGRES));
			}
