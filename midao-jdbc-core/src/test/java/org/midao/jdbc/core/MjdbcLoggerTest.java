...
public class MjdbcLoggerTest {
    ...
    public void testGetLoggerString() throws Exception {
        MjdbcLogger logger = MjdbcLogger.getLogger("log me!");
    ...
    public void testGetLoggerClass() throws Exception {
        MjdbcLogger logger = MjdbcLogger.getLogger(String.class);
    ...
    public void testIsSLF4jAvailable() throws Exception {
        Assert.assertEquals(false, MjdbcLogger.isSLF4jAvailable());
    }

    @Test
    public void testIsSLF4jImplementationAvailable() throws Exception {
        Assert.assertEquals(false, MjdbcLogger.isSLF4jImplementationAvailable());
    }
}
