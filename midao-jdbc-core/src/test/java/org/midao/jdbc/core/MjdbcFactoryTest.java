...
public class MjdbcFactoryTest {
    ...
    public void testGetQueryRunnerDataSource() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(ds) instanceof QueryRunner);
    }

    @Test
    public void testGetQueryRunnerDataSourceTypeHandler() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(ds, EmptyTypeHandler.class) instanceof QueryRunner);
    }

    @Test
    public void testGetQueryRunnerDataSourceTypeStatementHandler() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(ds, EmptyTypeHandler.class, BaseStatementHandler.class) instanceof QueryRunner);
    }

    @Test
    public void testGetQueryRunnerCoonection() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(conn) instanceof QueryRunner);
    }

    @Test
    public void testGetQueryRunnerConnectionTypeHandler() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(conn, EmptyTypeHandler.class) instanceof QueryRunner);
    }

    @Test
    public void testGetQueryRunnerConnectionTypeStatementHandler() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getQueryRunner(conn, EmptyTypeHandler.class, BaseStatementHandler.class) instanceof QueryRunner);
    }

    @Test
    public void testGetAsyncQueryRunner() throws Exception {
        Assert.assertEquals(true, MjdbcFactory.getAsyncQueryRunner(null, null) instanceof AsyncQueryRunner);
    }

    @Test(expected = NoClassDefFoundError.class)
    public void testCreateDataSourceProp() throws Exception {
        MjdbcFactory.createDataSource(new Properties());
    }

    @Test(expected = NoClassDefFoundError.class)
    public void testCreateDataSourceUrl1() throws Exception {
        MjdbcFactory.createDataSource("");
    }
    ...
    public void testCreateDataSourceUrl4() throws Exception {
        MjdbcFactory.createDataSource("", "", "", "", 0, 0);
    }
}
