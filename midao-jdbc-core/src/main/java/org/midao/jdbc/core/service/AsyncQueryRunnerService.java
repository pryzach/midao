...
public interface AsyncQueryRunnerService {
    ...
    /**
     * @see QueryRunnerService#batch(org.midao.jdbc.core.handlers.input.InputHandler[])
     */
    public Future<int[]> batch(final InputHandler[] inputHandlers) throws SQLException;

    /**
     * @see QueryRunnerService#query(String, org.midao.jdbc.core.handlers.output.OutputHandler, Object...)
     */
    public <T> Future<T> query(final String sql, final OutputHandler<T> outputHandler, final Object... params) throws SQLException;

    /**
     * @see QueryRunnerService#query(org.midao.jdbc.core.handlers.input.InputHandler, org.midao.jdbc.core.handlers.output.OutputHandler)
     */
    public <T> Future<T> query(final InputHandler inputHandler, final OutputHandler<T> outputHandler) throws SQLException;

    /**
     * @see QueryRunnerService#query(String, org.midao.jdbc.core.handlers.output.OutputHandler)
     */
    ...
    /**
     * @see QueryRunnerService#update(org.midao.jdbc.core.handlers.input.InputHandler)
     */
    public Future<Integer> update(final InputHandler inputHandler) throws SQLException;

    /**
     * @see QueryRunnerService#update(org.midao.jdbc.core.handlers.input.InputHandler, org.midao.jdbc.core.handlers.output.OutputHandler)
     */
    public <T> Future<T> update(final InputHandler inputHandler, final OutputHandler<T> outputHandler) throws SQLException;

    /**
     * @see QueryRunnerService#update(String, org.midao.jdbc.core.handlers.output.OutputHandler, Object...)
     */
