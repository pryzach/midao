...
import org.midao.jdbc.core.handlers.input.named.MapInputHandlerEx;
...
/**
 */
public class QueryInputHandlerExExample1 {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            MapInputHandlerEx input = new MapInputHandlerEx("SELECT name FROM students WHERE id = #{id,jdbcType=INTEGER,mode=in}", queryParameters);
