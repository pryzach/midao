...
/**
 */
public class QueryMultipleParameterUsageExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            MapInputHandler input = new MapInputHandler("SELECT name FROM students WHERE id = :id OR id > :id", queryParameters);
