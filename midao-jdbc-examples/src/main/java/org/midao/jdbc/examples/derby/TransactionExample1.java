...
public class TransactionExample1 {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            MapInputHandler input = new MapInputHandler("SELECT name FROM students WHERE id = 1", null);

            Map<String, Object> result = runner.query(input, new MapOutputHandler());
            // after transaction is finished - it should be finished(committed) even if no write operation was performed.
            runner.commit();
