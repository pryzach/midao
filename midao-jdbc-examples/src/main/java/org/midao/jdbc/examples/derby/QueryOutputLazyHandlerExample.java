...
public class QueryOutputLazyHandlerExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            MapListLazyOutputHandler lazyMapList =  runner.query(input, new MapListLazyOutputHandler());

            BeanListLazyOutputHandler lazyBeanList = runner.query(input, new BeanListLazyOutputHandler<Student>(Student.class));
