...
/**
 */
public class JDBC3TypeHandlerTest {
    ...
    public void testProcessInput() throws Exception {
        new JDBC3TypeHandler(new Overrider()).processInput(stmt, params);
    ...
    public void testAfterExecute() throws Exception {
        ...
        new JDBC3TypeHandler(new Overrider()).afterExecute(stmt, processedParams, params);
    ...
    public void testProcessOutput() throws Exception {
        new JDBC3TypeHandler(new Overrider()).processOutput(stmt, params);
    ...
    public void testProcessOutputList() throws Exception {
        ...
        new JDBC3TypeHandler(new Overrider()).processOutput(stmt, paramsList);
