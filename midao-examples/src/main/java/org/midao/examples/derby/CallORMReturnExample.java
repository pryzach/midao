...
public class CallORMReturnExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            runner.update("CREATE PROCEDURE TEST_PROC_RETURN (IN ID int) PARAMETER STYLE JAVA LANGUAGE JAVA DYNAMIC RESULT SETS 1 EXTERNAL NAME 'org.midao.examples.derby.CallORMReturnExample.testProcedureReturn'");
