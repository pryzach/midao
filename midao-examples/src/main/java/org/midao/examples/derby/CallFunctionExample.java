...
public class CallFunctionExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            runner.update("CREATE FUNCTION TEST_FUNC (ID integer) RETURNS varchar(30) PARAMETER STYLE JAVA LANGUAGE JAVA EXTERNAL NAME 'org.midao.examples.derby.CallFunctionExample.testFunction'");
