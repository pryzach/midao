...
import org.midao.examples.Student;
...
public class CallORMInputExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            runner.update("CREATE PROCEDURE TEST_NAMED (IN ID integer, OUT NAME varchar(50), OUT ADDRESS varchar(50)) PARAMETER STYLE JAVA LANGUAGE JAVA DYNAMIC RESULT SETS 0 EXTERNAL NAME 'org.midao.examples.derby.CallORMInputExample.testNamed'");
