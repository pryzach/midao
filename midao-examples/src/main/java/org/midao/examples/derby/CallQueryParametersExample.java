...
public class CallQueryParametersExample {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            runner.update("CREATE PROCEDURE TEST_INOUT (IN NAME varchar(50), INOUT SURNAME varchar(50), OUT FULLNAME varchar(50)) PARAMETER STYLE JAVA LANGUAGE JAVA DYNAMIC RESULT SETS 0 EXTERNAL NAME 'org.midao.examples.derby.CallQueryParametersExample.testInOut'");
